...
#if OUTPUTINFO
            cv::Mat otimg;
            cv::drawMatches(mLastFrame.mImg,mLastFrame.mvKeysUn,
                            mCurrentFrame.mImg,mCurrentFrame.mvKeysUn,
                            matches,otimg);
            cv::imwrite("/media/navinfo/Bak/OutPutImg/keymatch.jpg",otimg);
#endif 
            // Set Frame Poses
...
{
    //add by tu     every frame is keyframe
    return true;
